...
TEST(BitsInsertion_CArray, Ranges)
{
    {
        std::byte buffer [] = make_array(0xFF, 0xFF, 0xFF, 0xFF, 0xFF, 0xFF, 0xFF, 0xFF);
...
TEST(BitsInsertion_CArray, Ranges_Subranges)
{
    {
        std::byte buffer [] = make_array(0xFF, 0xFF, 0xFF, 0xFF, 0xFF, 0xFF, 0xFF, 0xFF);
...
TEST(BitsInsertion_CArray, Ranges_Small_Values)
{
    {
        std::byte buffer [] = make_array(0xFF, 0xFF, 0xFF, 0xFF, 0xFF, 0xFF, 0xFF, 0xFF);
...
TEST(BitsInsertion_CArray, TemplatedPosition_Ranges)
{
    {
        std::byte buffer [] = make_array(0xFF, 0xFF, 0xFF, 0xFF, 0xFF, 0xFF, 0xFF, 0xFF);
        uint8_t c_array[3] = { 0x5F, 0xF7, 0x03 };
...
TEST(BitsInsertion_CArray, TemplatedPosition_Ranges_Subranges)
{
    {
        std::byte buffer [] = make_array(0xFF, 0xFF, 0xFF, 0xFF, 0xFF, 0xFF, 0xFF, 0xFF);
        uint8_t c_array[6] = { 0x00, 0x5F, 0xF7, 0x03, 0x00, 0x00 };
...
TEST(BitsInsertion_CArray, TemplatedPosition_Ranges_Small_Values)
{
    {
        std::byte buffer [] = make_array(0xFF, 0xFF, 0xFF, 0xFF, 0xFF, 0xFF, 0xFF, 0xFF);
        uint8_t c_array[3] = { 0x05, 0x07, 0x03 };
