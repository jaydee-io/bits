...
TEST(BitsExtraction_CppArray, Unsigned_8bits)
{
...
{
    const auto buffer = make_array(0xDC, 0xFE, 0x3D, 0xCF, 0xDC, 0xFE, 0x3D, 0xC7);
...
TEST(BitsExtraction_CppArray, Signed_16bits)
{
    const auto buffer = make_array(0xDC, 0xFE, 0x3D, 0xCF, 0xDC, 0xFE, 0x3D, 0xC7);
...
TEST(BitsExtraction_CppArray, Signed_32bits)
{
    const auto buffer = make_array(0xDC, 0xFE, 0x3D, 0xCF, 0xDC, 0xFE, 0x3D, 0xC7);
...
TEST(BitsExtraction_CppArray, Ranges)
{
    const auto buffer = make_array(0x35, 0xFF, 0x70, 0x35, 0xFF, 0x70, 0x35, 0xFF);
...
TEST(BitsExtraction_CppArray, Ranges_Subranges)
{
    const auto buffer = make_array(0x35, 0xFF, 0x70, 0x35, 0xFF, 0x70, 0x35, 0xFF);
...
TEST(BitsExtraction_CppArray, Ranges_Small_Values)
{
    const auto buffer = make_array(0x35, 0xFF, 0x70, 0x35, 0xFF, 0x70, 0x35, 0xFF);
    ...
    ASSERT_THAT(c_array, ElementsAreArray(make_array<uint8_t>(0x05, 0x0F, 0x0F)));

    std::array<uint8_t, 3> std_array = {};
    bits::extract(buffer, std_array, 15, 4, 4);
    ASSERT_THAT(std_array, ElementsAreArray(make_array<uint8_t>(0x05, 0x0F, 0x0F)));

    std_array = {};
    std::span<uint8_t, 3> std_span(std_array);
    bits::extract(buffer, std_span, 15, 4, 4);
    ASSERT_THAT(std_span, ElementsAreArray(make_array<uint8_t>(0x05, 0x0F, 0x0F)));

    std::vector<uint8_t> std_vector(3, 0);
    bits::extract(buffer, std_vector, 15, 4, 4);
    ASSERT_THAT(std_vector, ElementsAreArray(make_array<uint8_t>(0x05, 0x0F, 0x0F)));

    std::list<uint8_t> std_list(3, 0);
    bits::extract(buffer, std_list, 15, 4, 4);
    ASSERT_THAT(std_list, ElementsAreArray(make_array<uint8_t>(0x05, 0x0F, 0x0F)));
...
TEST(BitsExtraction_CppArray, TemplatedPosition_Unsigned_8bits)
{
    const auto buffer = make_array(0x35, 0xFF, 0x70, 0x35, 0xFF, 0x70, 0x35, 0xFF);
...
TEST(BitsExtraction_CppArray, TemplatedPosition_Signed_16bits)
{
    const auto buffer = make_array(0xDC, 0xFE, 0x3D, 0xCF, 0xDC, 0xFE, 0x3D, 0xC7);
...
TEST(BitsExtraction_CppArray, TemplatedPosition_Signed_32bits)
{
    const auto buffer = make_array(0xDC, 0xFE, 0x3D, 0xCF, 0xDC, 0xFE, 0x3D, 0xC7);
...
TEST(BitsExtraction_CppArray, TemplatedPosition_Ranges)
{
    const auto buffer = make_array(0x35, 0xFF, 0x70, 0x35, 0xFF, 0x70, 0x35, 0xFF);
...
TEST(BitsExtraction_CppArray, TemplatedPosition_Ranges_Subranges)
{
    const auto buffer = make_array(0x35, 0xFF, 0x70, 0x35, 0xFF, 0x70, 0x35, 0xFF);
...
TEST(BitsExtraction_CppArray, TemplatedPosition_Ranges_Small_Values)
{
    const auto buffer = make_array(0x35, 0xFF, 0x70, 0x35, 0xFF, 0x70, 0x35, 0xFF);
