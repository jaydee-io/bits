...
{
    std::array<uint8_t, 8> buffer = { 0x00, 0x00, 0x00, 0x00, 0x00, 0x00, 0x00, 0x00 };
...
TEST(BitsInsertion_CppArray, Signed_8bits_empty_buffer)
{
    ...
    bits::insert<int8_t>(  -3, buffer, 3,  0 ); ASSERT_THAT(buffer, ElementsAre(0xD0, 0x00, 0x00, 0x00, 0x00, 0x00, 0x00, 0x00));
    bits::insert<int8_t>(  -1, buffer, 5,  4 ); ASSERT_THAT(buffer, ElementsAre(0xDC, 0x00, 0x00, 0x00, 0x00, 0x00, 0x00, 0x00));
    bits::insert<int8_t>(  63, buffer, 13, 6 ); ASSERT_THAT(buffer, ElementsAre(0xDC, 0xFC, 0x00, 0x00, 0x00, 0x00, 0x00, 0x00));
    bits::insert<int8_t>(-113, buffer, 21, 14); ASSERT_THAT(buffer, ElementsAre(0xDC, 0xFE, 0x3C, 0x00, 0x00, 0x00, 0x00, 0x00));
    bits::insert<int8_t>( 115, buffer, 29, 22); ASSERT_THAT(buffer, ElementsAre(0xDC, 0xFE, 0x3D, 0xCC, 0x00, 0x00, 0x00, 0x00));
}
...
TEST(BitsInsertion_CppArray, Signed_16bits_empty_buffer)
{
    ...
    bits::insert<int16_t>(   -3, buffer, 3,  0 ); ASSERT_THAT(buffer, ElementsAre(0xD0, 0x00, 0x00, 0x00, 0x00, 0x00, 0x00, 0x00));
    bits::insert<int16_t>(   -1, buffer, 5,  4 ); ASSERT_THAT(buffer, ElementsAre(0xDC, 0x00, 0x00, 0x00, 0x00, 0x00, 0x00, 0x00));
    bits::insert<int16_t>(   63, buffer, 13, 6 ); ASSERT_THAT(buffer, ElementsAre(0xDC, 0xFC, 0x00, 0x00, 0x00, 0x00, 0x00, 0x00));
    bits::insert<int16_t>(-7204, buffer, 27, 14); ASSERT_THAT(buffer, ElementsAre(0xDC, 0xFE, 0x3D, 0xC0, 0x00, 0x00, 0x00, 0x00));
}
...
TEST(BitsInsertion_CppArray, Signed_32bits_empty_buffer)
{
    ...
    bits::insert<int32_t>(     -3, buffer, 3,  0 ); ASSERT_THAT(buffer, ElementsAre(0xD0, 0x00, 0x00, 0x00, 0x00, 0x00, 0x00, 0x00));
    bits::insert<int32_t>(     -1, buffer, 5,  4 ); ASSERT_THAT(buffer, ElementsAre(0xDC, 0x00, 0x00, 0x00, 0x00, 0x00, 0x00, 0x00));
    bits::insert<int32_t>(     63, buffer, 13, 6 ); ASSERT_THAT(buffer, ElementsAre(0xDC, 0xFC, 0x00, 0x00, 0x00, 0x00, 0x00, 0x00));
    bits::insert<int32_t>(  -7204, buffer, 27, 14); ASSERT_THAT(buffer, ElementsAre(0xDC, 0xFE, 0x3D, 0xC0, 0x00, 0x00, 0x00, 0x00));
    bits::insert<int32_t>(-573553, buffer, 53, 28); ASSERT_THAT(buffer, ElementsAre(0xDC, 0xFE, 0x3D, 0xFF, 0xDC, 0xFE, 0x3C, 0x00));
}
...
TEST(BitsInsertion_CppArray, Signed_8bits_no_empty_buffer)
{
    ...
    bits::insert<int8_t>(  -3, buffer, 3,  0 ); ASSERT_THAT(buffer, ElementsAre(0xDF, 0xFF, 0xFF, 0xFF, 0xFF, 0xFF, 0xFF, 0xFF));
    bits::insert<int8_t>(  -1, buffer, 5,  4 ); ASSERT_THAT(buffer, ElementsAre(0xDF, 0xFF, 0xFF, 0xFF, 0xFF, 0xFF, 0xFF, 0xFF));
    bits::insert<int8_t>(  63, buffer, 13, 6 ); ASSERT_THAT(buffer, ElementsAre(0xDC, 0xFF, 0xFF, 0xFF, 0xFF, 0xFF, 0xFF, 0xFF));
    bits::insert<int8_t>(-113, buffer, 21, 14); ASSERT_THAT(buffer, ElementsAre(0xDC, 0xFE, 0x3F, 0xFF, 0xFF, 0xFF, 0xFF, 0xFF));
    bits::insert<int8_t>( 115, buffer, 29, 22); ASSERT_THAT(buffer, ElementsAre(0xDC, 0xFE, 0x3D, 0xCF, 0xFF, 0xFF, 0xFF, 0xFF));
}
...
TEST(BitsInsertion_CppArray, Signed_16bits_no_empty_buffer)
{
    ...
    bits::insert<int16_t>(   -3, buffer, 3,  0 ); ASSERT_THAT(buffer, ElementsAre(0xDF, 0xFF, 0xFF, 0xFF, 0xFF, 0xFF, 0xFF, 0xFF));
    bits::insert<int16_t>(   -1, buffer, 5,  4 ); ASSERT_THAT(buffer, ElementsAre(0xDF, 0xFF, 0xFF, 0xFF, 0xFF, 0xFF, 0xFF, 0xFF));
    bits::insert<int16_t>(   63, buffer, 13, 6 ); ASSERT_THAT(buffer, ElementsAre(0xDC, 0xFF, 0xFF, 0xFF, 0xFF, 0xFF, 0xFF, 0xFF));
    bits::insert<int16_t>(-7204, buffer, 27, 14); ASSERT_THAT(buffer, ElementsAre(0xDC, 0xFE, 0x3D, 0xCF, 0xFF, 0xFF, 0xFF, 0xFF));
}
...
TEST(BitsInsertion_CppArray, Signed_32bits_no_empty_buffer)
{
    ...
    bits::insert<int32_t>(     -3, buffer, 3,  0 ); ASSERT_THAT(buffer, ElementsAre(0xDF, 0xFF, 0xFF, 0xFF, 0xFF, 0xFF, 0xFF, 0xFF));
    bits::insert<int32_t>(     -1, buffer, 5,  4 ); ASSERT_THAT(buffer, ElementsAre(0xDF, 0xFF, 0xFF, 0xFF, 0xFF, 0xFF, 0xFF, 0xFF));
    bits::insert<int32_t>(     63, buffer, 13, 6 ); ASSERT_THAT(buffer, ElementsAre(0xDC, 0xFF, 0xFF, 0xFF, 0xFF, 0xFF, 0xFF, 0xFF));
    bits::insert<int32_t>(  -7204, buffer, 27, 14); ASSERT_THAT(buffer, ElementsAre(0xDC, 0xFE, 0x3D, 0xCF, 0xFF, 0xFF, 0xFF, 0xFF));
    bits::insert<int32_t>(-573553, buffer, 53, 28); ASSERT_THAT(buffer, ElementsAre(0xDC, 0xFE, 0x3D, 0xFF, 0xDC, 0xFE, 0x3F, 0xFF));
}
...
TEST(BitsInsertion_CppArray, TemplatedPosition_Signed_8bits_empty_buffer)
{
    ...
    bits::insert<int8_t, 3,  0 >(  -3, buffer); ASSERT_THAT(buffer, ElementsAre(0xD0, 0x00, 0x00, 0x00, 0x00, 0x00, 0x00, 0x00));
    bits::insert<int8_t, 5,  4 >(  -1, buffer); ASSERT_THAT(buffer, ElementsAre(0xDC, 0x00, 0x00, 0x00, 0x00, 0x00, 0x00, 0x00));
    bits::insert<int8_t, 13, 6 >(  63, buffer); ASSERT_THAT(buffer, ElementsAre(0xDC, 0xFC, 0x00, 0x00, 0x00, 0x00, 0x00, 0x00));
    bits::insert<int8_t, 21, 14>(-113, buffer); ASSERT_THAT(buffer, ElementsAre(0xDC, 0xFE, 0x3C, 0x00, 0x00, 0x00, 0x00, 0x00));
    bits::insert<int8_t, 29, 22>( 115, buffer); ASSERT_THAT(buffer, ElementsAre(0xDC, 0xFE, 0x3D, 0xCC, 0x00, 0x00, 0x00, 0x00));
}
...
TEST(BitsInsertion_CppArray, TemplatedPosition_Signed_16bits_empty_buffer)
{
    ...
    bits::insert<int16_t, 3,  0 >(   -3, buffer); ASSERT_THAT(buffer, ElementsAre(0xD0, 0x00, 0x00, 0x00, 0x00, 0x00, 0x00, 0x00));
    bits::insert<int16_t, 5,  4 >(   -1, buffer); ASSERT_THAT(buffer, ElementsAre(0xDC, 0x00, 0x00, 0x00, 0x00, 0x00, 0x00, 0x00));
    bits::insert<int16_t, 13, 6 >(   63, buffer); ASSERT_THAT(buffer, ElementsAre(0xDC, 0xFC, 0x00, 0x00, 0x00, 0x00, 0x00, 0x00));
    bits::insert<int16_t, 27, 14>(-7204, buffer); ASSERT_THAT(buffer, ElementsAre(0xDC, 0xFE, 0x3D, 0xC0, 0x00, 0x00, 0x00, 0x00));
}
...
TEST(BitsInsertion_CppArray, TemplatedPosition_Signed_32bits_empty_buffer)
{
    ...
    bits::insert<int32_t, 3,  0 >(     -3, buffer); ASSERT_THAT(buffer, ElementsAre(0xD0, 0x00, 0x00, 0x00, 0x00, 0x00, 0x00, 0x00));
    bits::insert<int32_t, 5,  4 >(     -1, buffer); ASSERT_THAT(buffer, ElementsAre(0xDC, 0x00, 0x00, 0x00, 0x00, 0x00, 0x00, 0x00));
    bits::insert<int32_t, 13, 6 >(     63, buffer); ASSERT_THAT(buffer, ElementsAre(0xDC, 0xFC, 0x00, 0x00, 0x00, 0x00, 0x00, 0x00));
    bits::insert<int32_t, 27, 14>(  -7204, buffer); ASSERT_THAT(buffer, ElementsAre(0xDC, 0xFE, 0x3D, 0xC0, 0x00, 0x00, 0x00, 0x00));
    bits::insert<int32_t, 53, 28>(-573553, buffer); ASSERT_THAT(buffer, ElementsAre(0xDC, 0xFE, 0x3D, 0xFF, 0xDC, 0xFE, 0x3C, 0x00));
}
...
TEST(BitsInsertion_CppArray, TemplatedPosition_Signed_8bits_no_empty_buffer)
{
    ...
    bits::insert<int8_t, 3,  0 >(  -3, buffer); ASSERT_THAT(buffer, ElementsAre(0xDF, 0xFF, 0xFF, 0xFF, 0xFF, 0xFF, 0xFF, 0xFF));
    bits::insert<int8_t, 5,  4 >(  -1, buffer); ASSERT_THAT(buffer, ElementsAre(0xDF, 0xFF, 0xFF, 0xFF, 0xFF, 0xFF, 0xFF, 0xFF));
    bits::insert<int8_t, 13, 6 >(  63, buffer); ASSERT_THAT(buffer, ElementsAre(0xDC, 0xFF, 0xFF, 0xFF, 0xFF, 0xFF, 0xFF, 0xFF));
    bits::insert<int8_t, 21, 14>(-113, buffer); ASSERT_THAT(buffer, ElementsAre(0xDC, 0xFE, 0x3F, 0xFF, 0xFF, 0xFF, 0xFF, 0xFF));
    bits::insert<int8_t, 29, 22>( 115, buffer); ASSERT_THAT(buffer, ElementsAre(0xDC, 0xFE, 0x3D, 0xCF, 0xFF, 0xFF, 0xFF, 0xFF));
}
...
TEST(BitsInsertion_CppArray, TemplatedPosition_Signed_16bits_no_empty_buffer)
{
    ...
    bits::insert<int16_t, 3,  0 >(   -3, buffer); ASSERT_THAT(buffer, ElementsAre(0xDF, 0xFF, 0xFF, 0xFF, 0xFF, 0xFF, 0xFF, 0xFF));
    bits::insert<int16_t, 5,  4 >(   -1, buffer); ASSERT_THAT(buffer, ElementsAre(0xDF, 0xFF, 0xFF, 0xFF, 0xFF, 0xFF, 0xFF, 0xFF));
    bits::insert<int16_t, 13, 6 >(   63, buffer); ASSERT_THAT(buffer, ElementsAre(0xDC, 0xFF, 0xFF, 0xFF, 0xFF, 0xFF, 0xFF, 0xFF));
    bits::insert<int16_t, 27, 14>(-7204, buffer); ASSERT_THAT(buffer, ElementsAre(0xDC, 0xFE, 0x3D, 0xCF, 0xFF, 0xFF, 0xFF, 0xFF));
}
...
TEST(BitsInsertion_CppArray, TemplatedPosition_Signed_32bits_no_empty_buffer)
{
    ...
    bits::insert<int32_t, 3,  0 >(     -3, buffer); ASSERT_THAT(buffer, ElementsAre(0xDF, 0xFF, 0xFF, 0xFF, 0xFF, 0xFF, 0xFF, 0xFF));
    bits::insert<int32_t, 5,  4 >(     -1, buffer); ASSERT_THAT(buffer, ElementsAre(0xDF, 0xFF, 0xFF, 0xFF, 0xFF, 0xFF, 0xFF, 0xFF));
    bits::insert<int32_t, 13, 6 >(     63, buffer); ASSERT_THAT(buffer, ElementsAre(0xDC, 0xFF, 0xFF, 0xFF, 0xFF, 0xFF, 0xFF, 0xFF));
    bits::insert<int32_t, 27, 14>(  -7204, buffer); ASSERT_THAT(buffer, ElementsAre(0xDC, 0xFE, 0x3D, 0xCF, 0xFF, 0xFF, 0xFF, 0xFF));
    bits::insert<int32_t, 53, 28>(-573553, buffer); ASSERT_THAT(buffer, ElementsAre(0xDC, 0xFE, 0x3D, 0xFF, 0xDC, 0xFE, 0x3F, 0xFF));
}
